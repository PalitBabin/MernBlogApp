...
export const signupUser = async (req, res) => {
    try {
        //const salt = await bcrypt.genSalt();    ---> old method
        const hashedPassword = await bcrypt.hash(req.body.password,10);    // automatically generate salt by using 2nd argument in hash i.e salt has 10 characters long
